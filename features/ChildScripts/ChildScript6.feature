Feature: Validate API Task - Data for the API task is from FO & BO. - Unique Key is from FO and other data from BO

    @ChildScript
    @ChildScript6
    @APITaskFO-UF-BO-Data
    #Createdby: Manikanta
    Scenario: Use case to demonstrate API Task - Data for the API task is from FO & BO. - Unique Key is from FO and other data from BO
        Given user login to "Finlevit_admin" with "GroupAdmins" credentials
        And User get the Test data from "Usecase_TestData/ChildScript6" json file in "WorkFlow UI" screen
        ...
        And User Drag and Drop below widgets in "CanvasBody" in "UniqueWidgetFields" screen
            ...
            | Button | 500 | 125 | Submit    | Submit     | Submit | Save   |
        ...
        And User Drag and Drop below widgets in "CanvasBody" in "UniqueWidgetFields" screen
            | Widget     | X   | Y   | FieldName | FieldLabel |
            | Text Input | 500 | 125 | FirstName | First Name |
        ...
        And User Drag and Drop in BO below widgets in "CanvasBody" in "UniqueWidgetFields" screen
            | Widget     | X   | Y   | FieldName | FieldLabel |
            | Text Input | 150 | 650 | BOPin     | BO Pin     |

        Then User click on "FO Fields" "FOFields" in "UniqueWidgetFields" screen
        ...
        Then User will Drag and Drop below task on "BackOfficeCanvas" in "tasks" screen
            ...
            | Task   | 500 | 200 | Review   | Application Manager | 1           | Save    | In Progress   | 1        | 0       |
        ...
        Then User will Drag and Drop below task on "BackOfficeCanvas" in "tasks" screen
            ...
            | API Task | 300 | 400 | Create Record | In Progress  | In Progress  | Application Manager | Mary PI Details | Save Mary PI Details |
        ...
        Then User will Drag and Drop below task on "BackOfficeCanvas" in "tasks" screen
            ...
            | Response Mapping | 500 | 400 | Get Response | In Progress  | In Progress  | Application Manager | Create Record |
        ...
        Then User will Drag and Drop below task on "BackOfficeCanvas" in "tasks" screen
            | Widget | X   | Y   | TaskName | Role                | noOfActions | Action1 | Action1Status | SLAHours | SLADays |
            | Task   | 700 | 400 | Verify   | Application Manager | 1           | Accept  | In Progress   | 1        | 0       |
