Feature: Existing application with SQS Queue

    Background: Create File setup for Existing Application
        Given user login to "Finlevit_admin" with "Admin" credentials
        And User get the Test data from "Usecase_TestData/ChildScript77" json file in "WorkFlow UI" screen
    ...
    @ChildScript77
    # @ChildScript
    Scenario: Existing application with SQS Queue
        #CreateGroup
        # Given user login to "Finlevit_admin" with "Admin" credentials
        And User get the Test data from "Usecase_TestData/ChildScript77" json file in "WorkFlow UI" screen
        ...
        And User copy "ProcessType" save "ProcessType" in "ChildScript77_Payload" json file
        And User copy "FileName" save "SourceID" in "ChildScript77_Payload" json file
        ...
        #Submit Transaction
        Given User get the Test data from "Usecase_TestData/ChildScript77_Payload" json file in "API" screen
        And "Finlevit_admin" get the access token using "Access_Token" call
        Then User submits transaction for "ChildScript77_Payload"
        And User get the Test data from "Usecase_TestData/ChildScript77" json file in "WorkFlow UI" screen
