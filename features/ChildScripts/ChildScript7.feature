Feature: Validate API Task - Data for the API task is from FO & BO. - Unique Key is from BO and other data from FO

    @ChildScript
    @ChildScript7
    @APITaskFO-Data-BO-UF
    #Createdby: Manikanta
    Scenario: Use case to demonstrate API Task - Data for the API task is from FO & BO. - Unique Key is from BO and other data from FO
        Given user login to "Finlevit_admin" with "GroupAdmins" credentials
        And User get the Test data from "Usecase_TestData/ChildScript7" json file in "WorkFlow UI" screen
        ...
        And User Drag and Drop below widgets in "CanvasBody" in "UniqueWidgetFields" screen
            ...
            | Container | 25 | 25 | ChildScript7 | Child Script 7 - Personal Information |
        When User expand "Container" widgets in "CanvasBody" in "UniqueWidgetFields" screen
            | Widget         | X    | Y   |
            | Child Script 7 | 1050 | 600 |
        ...
        Then User will Drag and Drop below task on "BackOfficeCanvas" in "tasks" screen
            ...
            | Task   | 300 | 100 | Review   | Application Manager | 1           | Save    | In Progress   | 1        | 0       |
        ...
        Then User will Drag and Drop below task on "BackOfficeCanvas" in "tasks" screen
            ...
            | API Task | 300 | 350 | Create Record | In Progress  | In Progress  | Application Manager | Mary PI Details | Save Mary PI Details |
...
#            | Zip   | Address_1_postalCode |
        ...
        Then User will Drag and Drop below task on "BackOfficeCanvas" in "tasks" screen
            ...
            | Response Mapping | 600 | 350 | Get Response | In Progress  | In Progress  | Application Manager | Create Record |
        ...
        Then User will Drag and Drop below task on "BackOfficeCanvas" in "tasks" screen
            | Widget | X   | Y   | TaskName | Role                | noOfActions | Action1 | Action1Status | SLAHours | SLADays |
            | Task   | 800 | 250 | Verify   | Application Manager | 1           | Accept  | In Progress   | 1        | 0       |
