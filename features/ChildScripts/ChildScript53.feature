Feature: Use case to validate payload widget properties/features
    ...
    Scenario: Usecase to checkout the version
        ...
        And User get the Test data from "Usecase_TestData/ChildScript53" json file in "WorkFlow UI" screen
        ...
        And User Drag and Drop below widgets in "CanvasBody" in "UniqueWidgetFields" screen
            ...
            | Dropdown   | 600 | 50 | EmpType   | Emp Type   |        |        | ManualOptions | 2          | Full Time | Part Time |
            | SSN        | 850 | 50 | ssnITIN   | SSN/ITIN   |        |        |               |            |           |           |
        And User Drag and Drop below widgets in "CanvasBody" in "UniqueWidgetFields" screen
        ...
        And User Drag and Drop below widgets in "CanvasBody" in "UniqueWidgetFields" screen
            ...
            | Checkbox     | 850 | 250 | IAcceptterms | I Accept terms |                    |
        ...
        Then User "Salary" field with "NumMaxValue" characters of "10" in "UniqueWidgetFields" pageScreen

        Then User "FirstName" field with "MinimumValue" characters of "3" in "UniqueWidgetFields" pageScreen
        Then User "Salary" field with "NumMinValue" characters of "3" in "UniqueWidgetFields" pageScreen
        ...
        Then User add placeholder value to "Salary" field as "1234567890" in "UniqueWidgetFields" pageScreen
        ...
        When User Widget should have attribute "ng-reflect-model" value of "1234567890" in "SalaryDefault" in "PayloadValidate" screen
        When User enter "" text in "Salary" field
        When User Widget should have attribute "ng-reflect-model" value of "123-45-6789" in "SsnDefault" in "payload" screen
        ...
        When User should validate in payload placeholder value of "1234567890" in "Salary" in "PayloadValidate" screen
        ...
        And User see text "Minimum length is 3" in "LeastValValidationMsg" in "PayloadValidate" screen
        When User enter "Test123456" text in "FirstName" field
        And User see text "Characters left 0" in "FirstNameMaxChar" in "PayloadValidate" screen

        # Number
        When User enter "" text in "Salary" field
        Then User click on "button" "Submit_btn" in "payload" screen
        And User see text "Salary field is empty" in "Salary" widget in "PayloadValidate" screen
        When User enter "1" text in "Salary" field
        ...
        And User see text "Characters left 0" in "SalaryMaxChar" in "PayloadValidate" screen
