Feature:Enhanced use for Business rules with And OR ElseIf maximum operators covered

  @ChildScript54 @ChildScript
  @enhanceBusinessRule
  #Createdby: Mohan S

  Scenario: Use case to cover maximum operators in Business rules with multiple widgets
    Given user login to "Finlevit_admin" with "GroupAdmins" credentials
    And User get the Test data from "Usecase_TestData/ChildScript54" json file in "WorkFlow UI" screen
    ...
    And User Drag and Drop below widgets in "CanvasBody" in "UniqueWidgetFields" screen
      ...
      | Button | 800 | 825 | Submit    | Submit     | Submit | Save   |
