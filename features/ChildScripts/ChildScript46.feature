...
Feature: Application to check Edit Styles and Apply styles to Application

  # @ChildScript
  @ChildScript46
  #Createdby: Mary
  #CreatedDate:06/07/2023
  Scenario: Use case to to check Edit Styles and Apply styles to Application

    Given user login to "Finlevit_admin" with "Admin" credentials
    And User get the Test data from "Usecase_TestData/ChildScript46" json file in "WorkFlow UI" screen
    ...
    Then User click on "button" "group_settings" in "Groups" screen
    Then User click on "button" "StylesMenu" in "GroupSetting" screen
    And User Edit style in "GroupSetting" screen
      | StyleName             | WidgetType | LabelFontStyle | InputFontStyle |
      | Automation Text Input | TextInput  | Georgia        | Segoe UI       |
      | Automation Number     | Number     | Georgia        | Segoe UI       |
      | Automation Text Area  | TextArea   | Georgia        | Segoe UI       |
      | Automation Email      | Email      | Georgia        | Segoe UI       |
      | Automation Password   | Password   | Georgia        | Segoe UI       |

    And User Edit style in "GroupSetting" screen
      | StyleName              | WidgetType  | LabelFontStyle | InputFontStyle |
      | Automation PhoneNumber | PhoneNumber | Georgia        | Segoe UI       |
      | Automation SSN Input   | SSNInput    | Georgia        | Segoe UI       |
      | Automation Dropdown    | Dropdown    | Georgia        | Segoe UI       |
      | Automation Date        | Date        | Georgia        | Segoe UI       |

    And User Edit style in "GroupSetting" screen
      | StyleName         | WidgetType | LabelFontStyle |
      | Automation Button | Button     | Georgia        |

    And User Edit style in "GroupSetting" screen
      | StyleName                | WidgetType   | TabFontStyle |
      | Automation Tab Container | TabContainer | Georgia      |

    And User Edit style in "GroupSetting" screen
      | StyleName           | WidgetType | LabelFontStyle |
      | Automation Checkbox | Checkbox   | Georgia        |

    And User Edit style in "GroupSetting" screen
      | StyleName                 | WidgetType    | LabelFontStyle | OptionFontStyle |
      | Automation Checkbox Group | CheckboxGroup | Georgia        | Segoe UI        |

    And User Edit style in "GroupSetting" screen
      | StyleName              | WidgetType | LabelFontStyle | OptionFontStyle |
      | Automation Radio Group | RadioGroup | Georgia        | Segoe UI        |
    ...
    And User validate CSS Property for "Edit" style in "UniqueWidgetFields" screen
      | WidgetName             | WidgetType     | FontSize | FontStyle      | Color             | InputFontSize | InputFontStyle    | InputColor       |
      | Personal Information   | Tabs Container | 15px     | Georgia, serif | rgb(181, 63, 89)  |               |                   |                  |
      | Employment Information | Tabs Container | 15px     | Georgia, serif | rgb(181, 63, 89)  |               |                   |                  |
      | First Name             | Text Input     | 15px     | Georgia, serif | rgb(74, 186, 176) | 15px          | "Segoe UI", serif | rgb(25, 71, 117) |
      | SurName                | Text Area      | 15px     | Georgia, serif | rgb(74, 186, 176) | 15px          | "Segoe UI", serif | rgb(25, 71, 117) |
      | Phone Number           | Phone Number   | 15px     | Georgia, serif | rgb(74, 186, 176) | 15px          | "Segoe UI", serif | rgb(25, 71, 117) |
      | Email                  | Email          | 15px     | Georgia, serif | rgb(74, 186, 176) | 15px          | "Segoe UI", serif | rgb(25, 71, 117) |
      | Date of Birth          | Date Picker    | 15px     | Georgia, serif | rgb(74, 186, 176) | 15px          | "Segoe UI", serif | rgb(25, 71, 117) |
      | SSN/ITIN               | SSN            | 15px     | Georgia, serif | rgb(74, 186, 176) | 15px          | "Segoe UI", serif | rgb(25, 71, 117) |
    ...
    And User validate CSS Property for "Edit" style in "UniqueWidgetFields" screen
      ...
      | Gender     | Radio Group | 15px     | Georgia, serif | rgb(74, 186, 176) | 15px            | rgb(25, 71, 117) | "Segoe UI", serif | rgb(198, 37, 37) | 15px           |
    ...
    And User validate CSS Property for "Edit" style in "UniqueWidgetFields" screen
      ...
      | Languages Known | Checkbox Group | 15px     | Georgia, serif | rgb(74, 186, 176) | 15px         | rgb(25, 71, 117) | "Segoe UI", serif | rgb(198, 37, 37) | 15px           |

    And User validate CSS Property for "Edit" style in "UniqueWidgetFields" screen
      | WidgetName    | WidgetType | FontSize | FontStyle      | Color             |
      | Is US Citizen | Checkbox   | 15px     | Georgia, serif | rgb(74, 186, 176) |

    And User validate CSS Property for "Edit" style in "UniqueWidgetFields" screen
      | WidgetName | WidgetType | FontSize | FontStyle      | Color             | BgColor          |
      | Submit     | Button     | 14px     | Georgia, serif | rgb(74, 186, 176) | rgb(181, 63, 89) |

    Then User click on "Button" widget "Employment Information" in "payload" screen
    And User validate CSS Property for "Edit" style in "UniqueWidgetFields" screen
      | WidgetName | WidgetType | FontSize | FontStyle      | Color             | InputFontSize | InputFontStyle    | InputColor       |
      | User Name      | Text Input | 15px     | Georgia, serif | rgb(74, 186, 176) | 15px          | "Segoe UI", serif  | rgb(25, 71, 117) |
      | Password   | Password   | 15px     | Georgia, serif | rgb(74, 186, 176) | 15px          | "Segoe UI", serif | rgb(25, 71, 117) |
      | Salary     | Number     | 15px     | Georgia, serif | rgb(74, 186, 176) | 15px          | "Segoe UI", serif | rgb(25, 71, 117) |
      | Emp Type   | Dropdown   | 15px     | Georgia, serif | rgb(74, 186, 176) | 15px          | "Segoe UI", serif | rgb(25, 71, 117) |
      | Address        | Text Input | 15px     | Georgia, serif | rgb(74, 186, 176) | 15px          | "Segoe UI", serif  | rgb(25, 71, 117) |
      | Address Line 2 | Text Input | 15px     | Georgia, serif | rgb(74, 186, 176) | 15px          | "Segoe UI", serif  | rgb(25, 71, 117) |
      | City           | Text Input | 15px     | Georgia, serif | rgb(74, 186, 176) | 15px          | "Segoe UI", serif  | rgb(25, 71, 117) |
      | Zip            | Text Input | 15px     | Georgia, serif | rgb(74, 186, 176) | 15px          | "Segoe UI", serif  | rgb(25, 71, 117) |
